...
public class recep extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        device1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    /* Switch is device 1 */
                    new recep.Background_get().execute("device1=1");
                } else {
                    new recep.Background_get().execute("device1=0");
                }
            }
        });
        ...
        device2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked) {
                    ...
                    new recep.Background_get().execute("device2=1");
                } else {
                    new recep.Background_get().execute("device2=0");
                }
            }
        });
        ...
        device3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked) {
                    /* Toggle button is device 2 */
                    new recep.Background_get().execute("device3=1");
                } else {
                    new recep.Background_get().execute("device3=0");
                }
            }
        });
        device4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked) {
                    /* Toggle button is device 2 */
                    new recep.Background_get().execute("device4=1");
                } else {
                    new recep.Background_get().execute("device4=0");
                }
            }
        });
    ...
    protected void onStart() {
        super.onStart();
        new recep.Background_get().execute("DevicesStates");
    }

    private void setDevicesnames() {
        SharedPreferences sharedPreferences = getSharedPreferences("recep_Devices", MODE_PRIVATE);
    ...
    protected void showInputDialog() {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(recep.this);
        View promptView = layoutInflater.inflate(R.layout.input_dialog, null);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(recep.this);
    ...
    private class Background_get extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(recep.this);
        ...
        protected void onPostExecute(String s) {
            if (!isCancelled()) {
                ...
                if (s.contains("device1=1")) {
                    recep.this.device1.setChecked(true);
                } else if (s.contains("device1=0")) {
                    recep.this.device1.setChecked(false);
                }
                if (s.contains("device2=1")) {
                    recep.this.device2.setChecked(true);
                } else if (s.contains("device2=0")) {
                    recep.this.device2.setChecked(false);
                }
                if (s.contains("device3=1")) {
                    recep.this.device3.setChecked(true);
                } else if (s.contains("device3=0")) {
                    recep.this.device3.setChecked(false);
                }
        ...
        protected void onCancelled() {
            super.onCancelled();
            progressDialog.dismiss();
            AlertDialog.Builder dlgAlert  = new AlertDialog.Builder(recep.this);
